...
class OperacaoRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'cotacao' => ['required', 'regex:/^[0-9]\d{0,2}(\.\d{3})*(,\d+)?$/'],
            'quantidade' => ['required', 'regex:/^[0-9]\d{0,2}(\.\d{3})*(,\d+)?$/'],
    ...
    public function messages()
    {
        return [
            ...
            'cotacao.regex' => 'O campo Cotação não é número válido. ex: 1,00, 1.000,00 ou 10.000,00',
            'quantidade.required' => 'O campo Quantidade é obrigatório',
            'quantidade.regex' => 'O campo Quantidade tem que ser número válido. ex: 0,00560060 ou 1,50 ou 1.000,00',
